    ...
    <div className="bg-white py-12 text-gray-800">
      <Container className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8 text-lg leading-relaxed">
          <p>
            At <strong>WearHaus</strong>, we are committed to protecting your
            privacy. This Privacy Policy describes how your personal information
            is collected, used, and shared when you visit or make a purchase
            from wearhaus.com (the &quot;Site&quot;).
          </p>
          ...
          <section>
            ...
            <p className="mb-2">
              ...
              are installed on your device. As you browse the Site, we collect
            ...
            <p>
              &quot;Personal Information&quot; in this Privacy Policy refers to
          ...
          <section>
            ...
            <p>
              ...
              use Sanity.io to power our online store—you can read more about
              how Sanity uses your Personal Information here:{' '}
              <a
          ...
          <section>
            ...
            <p>
              ...
              <a
                href="mailto:privacy@wearhaus.com"
                className="text-darkColor hover:underline"
              >
                privacy@wearhaus.com
              </a>{' '}
