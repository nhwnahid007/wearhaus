...
const FAQPage = () => {
  return (
    <div className="bg-white py-12 text-gray-800">
      {' '}
      {/* Added background and text color for consistency */}
      <Container className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="mb-10 text-lg text-center text-gray-600 max-w-2xl mx-auto">
          ...
          Wev&apos;e compiled a list of common inquiries to help you out.
        </p>
        <Accordion
          type="single"
          collapsible
        ...
        >
          {faqsData.map((faq, index) => (
            ...
            >
              <AccordionTrigger className="text-left text-xl font-semibold text-gray-800 group-hover:text-darkColor/90 transition-colors px-6 py-4 hover:no-underline">
                {' '}
                {/* Adjusted font size and padding */}
                {faq.question}
              </AccordionTrigger>
              <AccordionContent className="text-gray-700 px-6 pb-5 pt-0 leading-relaxed">
                {' '}
